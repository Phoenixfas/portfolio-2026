...
export default function CONTACT() {
    return (
        <div className='relative w-full h-full flex flex-col gap-5 lg:gap-[1vw]'>
            <h2 className='text-2xl leading-5 lg:text-[3vw] lg:leading-[2.3vw] roboto font-black text-white text-center'>GET IN TOUCH</h2>
            <div className="w-full flex flex-col lg:flex-row gap-[1.2vw] p-[1vw] pt-0">
                <div className="flex-1 h-fit flex flex-col gap-[1.2vw]">
                    <div className="flex flex-col">
                        <TornPaper className="p-[0.1vw] -rotate-6 -translate-x-1/12 z-20">
                            <TornPaper className="text-white px-[2vw] py-0" paperColor="bg-red-500">
                                <h2 className="text-base lg:text-[1.3vw] lg:leading-[2vw] roboto font-medium">
                                    EMAIL
                                </h2>
                            </TornPaper>
                        </TornPaper>
                    ...
                    <div className="flex items-center justify-between gap-[1.2vw]">
                        <div className="flex flex-col gap-2">
                            ...
                            <Link href="tel:+251967825549" className="text-white text-base lg:text-[1.3vw] lg:leading-[2vw] roboto font-medium hover:text-red-500 hover:scale-110 duration-300">
                                +251967825549
                            </Link>
                        </div>
                        <div className="flex flex-col gap-[0.3vw]">
                            ...
                            <div className="flex-1 text-white text-2xl lg:text-[1.8vw] flex justify-between gap-[0.3vw] flex-wrap p-3">
