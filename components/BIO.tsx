...
export default function BIO() {
    ...
    return (
        <div className="relative w-full h-full flex flex-col lg:flex-row gap-5">
            <div className="min-w-1/3 w-full lg:w-1/3 flex flex-col xs:flex-row lg:flex-col items-center gap-3 ">
                <div className="w-3/5 xs:w-auto xs:flex-1 lg:w-4/5">
                ...
                <p className="flex-1 text-white text-xl lg:text-[1.2vw] quicksand font-black">
                    FASIKA DAGNACHEW
                </p>
            </div>
            <div className="flex flex-col gap-3 h-full pr-3 ">
                <TornPaper className="text-black px-[2vw] py-0">
                    <h2 className="text-3xl lg:text-[3vw] lg:leading-[3.7vw] roboto font-black">
                        BIO
                    </h2>
                </TornPaper>
                <TornPaper className="text-black px-[.5vw] py-0">
                    <p className="text-base lg:text-[0.9vw] lg:leading-[2vw] roboto font-bold">
                        FULL STACK DEVELOPER | 3D ARTIST | TECH ENTHUSIAST
                    </p>
                </TornPaper>
                <div className="flex flex-col gap-2 max-h-60 pb-7 lg:pb-0 text-sm lg:max-h-fit lg:text-[0.9vw] lg:leading-[1.5vw] quicksand xs:overflow-y-scroll scrollbar-track-transparent scrollbar-thumb-red-700 scrollbar-thin">
